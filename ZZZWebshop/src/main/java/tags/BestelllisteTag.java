...
/**
 * BestelllisteTag Dieses Tag visualisiert die Bestellung eines Nutzers.
 * 
...
public class BestelllisteTag extends SimpleTagSupport {
	...
	/**
	 * Wir holen uns den aktuellen Warenkorb aus der Datenbank und anhand des
	 * Warenkorbs listen wir alle Artikel mit Name, Menge, Preis und Kategorie auf.
	 */
	public void doTag() throws JspException, IOException {
		...
		for (Warenkorb ware : warenkorb) {
			out.print("	<div class=\"card my-4\">" + "		<div class=\"card-body\">" + "			<div class=\"row\">"
					+ "				<div class=\"col col-6\">" + "					<h5 class=\"card-title\">"
					+ ware.getName() + "</h5>" + "				</div>" + "				<div class=\"col col-3\">"
					+ "					<h5 class=\"card-title\">" + ware.getMenge() + " x "
					+ String.format("%.02f", ware.getPreis()) + " &euro;</h5>" + "				</div>"
					+ "				<div class=\"col col-3\">" + "					<h5 class=\"card-title\">= "
					+ String.format("%.02f", ware.getPreis() * ware.getMenge()) + " &euro;</h5>"
					+ "				</div>" + "			</div>" + "		</div>"
