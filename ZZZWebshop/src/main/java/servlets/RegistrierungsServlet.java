 ...
 * Klasse für Registrierung des Benutzers
 * 
...
public class RegistrierungsServlet extends HttpServlet {
	 ...
	 * Überprüfung dieser Daten, ob diese den Vorgaben entsprechen und ob der Nutzer
			...
			if (RegEx.pruefeEmail(mail)) {
				if (EingabeValidierung.wiederholePW(passwort, passwortWDH)) {
					if (RegEx.pruefePasswort(passwort)) {
						...
						fehler += "Passwort entspricht nicht dem richtigen Format! (mind. 8 Zeichen inkl. Großbuchstabe, Kleinbuchstabe & Sonderzeichen)";
					}
